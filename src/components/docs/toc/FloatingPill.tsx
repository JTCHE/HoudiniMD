...
export function FloatingPill({
  ...
  return (
    <div
      ...
      className={`print:hidden @min-[780px]:hidden sticky top-[calc(var(--page-bar-h)+0.5rem)] z-20 h-0 transition-opacity duration-300 ease-out motion-reduce:transition-none ${
